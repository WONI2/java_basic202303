...
public class LibraryRepository {
    ...
    //검색어를 받으면 해당 검색어를 포함하는 제목을 가진 책정보들을 반환
    ...
    public String[] searchBookInfoList(String keyword) {
        ...
        for (Book book : bookList) {
            String title = book.getTitle(); //책의 제목들
...
//도서 대여 처리
    public RentStatus rentBook(int rentBookNum) {
        //대여를 원하는 책 추출
        Book wishBook = bookList[rentBookNum-1];
